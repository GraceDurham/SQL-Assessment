...
USING (brand_id)
WHERE m.name LIKE '%Mustang%' AND b.name LIKE '%Ford%';
...
SELECT models.year, models.name, model_id, awards.name FROM models LEFT OUTER JOIN awards ON (models.model_id = awards.winner_id)
